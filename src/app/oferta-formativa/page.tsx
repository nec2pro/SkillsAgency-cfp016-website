...
const formaciones: Formacion[] = [
  // Trayectos
  {
    ...
    description:
      "Especialización en sistemas eléctricos industriales y su mantenimiento.",
    tipo: "trayectos",
  },
  {
    ...
    description:
      "Formación en instalaciones eléctricas para edificios y propiedades.",
    tipo: "trayectos",
  },
  {
  ...
  },
  {
    ...
    description:
      "Formación en instalaciones de gas para unidades unifuncionales.",
    tipo: "trayectos",
  },
  {
    ...
    description:
      "Formación en instalación y mantenimiento de sistemas eléctricos con energías renovables.",
    tipo: "trayectos",
  },
  {
    id: "sanitarista",
    ...
    description:
      "Formación completa en instalaciones sanitarias y su mantenimiento.",
    tipo: "trayectos",
  },
  {
    id: "climatizacion",
    ...
    description:
      "Formación en instalación y reparación de sistemas de climatización.",
    tipo: "trayectos",
  },
  {
    ...
    description:
      "Especialización en instalaciones eléctricas domiciliarias y su mantenimiento.",
    tipo: "trayectos",
  },
  {
  ...
  },
  {
    ...
    description:
      "Especialización en análisis y procesamiento de datos para la toma de decisiones empresariales.",
    tipo: "trayectos",
  },
  {
    id: "informatica",
    ...
    description:
      "Formación en herramientas informáticas para la administración y gestión empresarial.",
    tipo: "trayectos",
  },
  {
    id: "programador",
    ...
    description:
      "Formación en desarrollo de software y programación de aplicaciones.",
    tipo: "trayectos",
  },
  // Capacitaciones Laborales
  {
    ...
    description:
      "Capacitación en gestión y procesamiento eficiente de datos empresariales.",
    tipo: "capacitaciones",
  },
  {
    id: "testing",
    ...
    description:
      "Formación en técnicas y herramientas para el testing de aplicaciones de software.",
    tipo: "capacitaciones",
  },
  {
    ...
    description:
      "Capacitación en herramientas y estrategias de marketing digital.",
    tipo: "capacitaciones",
  },
];
...
export default function OfertaFormativa() {
  ...
  const filteredFormaciones = formaciones.filter((formacion) => {
    const matchesType =
      selectedTypes.length === 0 || selectedTypes.includes(formacion.tipo);
    const matchesSede =
      selectedSedes.length === 0 ||
      formacion.sedes.some((sede) => selectedSedes.includes(sede));
    const matchesFamilia =
      selectedFamilias.length === 0 ||
      selectedFamilias.includes(formacion.familia);
                        ...
                        <div className="p-6">
                          ...
                          <div className="flex items-center gap-4 text-sm text-gray-500 mb-4">
                            ...
                            <div className="flex items-center gap-1">
                              ...
                              <span>
                                {formacion.familia.charAt(0).toUpperCase() +
                                  formacion.familia.slice(1)}
                              </span>
                            </div>
                          </div>
                          <Link
